...
const defaultColumns = [
...

  {
    ...
    renderCell: ({ row }) => <Typography variant='body2'  sx={{ color: 'text.secondary' }}>{row.name.toUpperCase() || '--'}</Typography>
  },
...
const IncomeCategory = () => {
  ...
  useEffect(()=> {
    dispatch(fetchIncomeCategory({page: page + 1, limit: 10}))
  ...
  return (
    ...
    <PageHeader toggle={toggleModal} action={'Create Category'}/>


        {/* <PageHeaderWithSearch searchPlaceholder={'Search Income'} action="Add Income" toggle={toggleModal} handleFilter={setKey}/> */}
        ...
        <Grid item xs={12}>
          <Card>
            <DataGrid
              ...
              pagination
              rowHeight={62}
              rows={IncomeCategoryData?.length ? IncomeCategoryData : []}
              columns={columns}
    ...
    <CreateCategory open={showModal} closeModal={toggleModal} fetchData={updateFetch} type={'income'} />
