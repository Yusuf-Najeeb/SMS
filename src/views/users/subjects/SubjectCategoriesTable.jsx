...
const SubjectCategoriesTable = () => {
  ...
  const ondeleteClick = () => {
    deleteCategory(categoryToDelete).then((res)=>{
      if(res.data.success){
        dispatch(fetchCategories({ page: 1, limit: 10, type: 'subject' }))
      }
    })
    doCancelDelete()
  }
...
<PageHeader toggle={OpenCategoryModal} action={'Add Category'} />
...
export default SubjectCategoriesTable
