...
const AddStudent = ({ open, closeModal, refetchData }) => {
  ...
  const onSubmit = async values => {
    ...
    const personalInformation = {
      ...
      profilePicture: imageLinkPayload,
      currentClassId: Number(currentClassId),
      ...restOfData,
      parentIds
    }

    const guardianData = guardianArray.length
      ? guardianArray.map(item => {
                ...
                <Fragment>
                  <Grid item xs={12} sm={4}>
                    <FormController
                      ...
                      error={guardianInfoErrors['firstName']}
                      errorMessage={guardianInfoErrors.firstName?.message}
                    />
                  </Grid>
                  ...
                  <Grid item xs={12} sm={4}>
                    <FormController
                      ...
                      error={guardianInfoErrors['lastName']}
                      errorMessage={guardianInfoErrors.lastName?.message}
                    />
                  </Grid>
                  ...
                  <Grid item xs={12} sm={4}>
                    <FormController
                      ...
                      error={guardianInfoErrors['phone']}
                      errorMessage={guardianInfoErrors.phone?.message}
                    />
                  </Grid>
                    ...
                    <Controller
                      ...
                      render={({ field: { value, onChange } }) => (
                        <CustomTextField
                          ...
                          {...(guardianInfoErrors.residentialAddress && {
                            helperText: guardianInfoErrors.residentialAddress.message
                          })}
                        />
                      )}
                    />
                  ...
                  <Grid item xs={12} sm={1} sx={{ mt: 2, mb: 2 }}>
                    <IconButton
                      size='large'
                      sx={{ justifySelf: 'flex-end', fontSize: '50px' }}
