    ...
    <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
      <Stack spacing={2} sx={{ width: '30%' }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <Typography sx={{ color: '#666', textTransform: 'uppercase' }}>{`${CurrentSessionData?.name} `}</Typography>
        </Box>

        <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
          <Typography sx={{ color: '#666', fontWeight: 700 }}>Term:</Typography>

          <Typography sx={{ color: '#666', textTransform: 'uppercase' }}>{`${CurrentSessionData?.term} `}</Typography>
        </Box>
