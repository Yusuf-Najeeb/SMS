...
import { updateStaffPersonalInfoSchema , updatestaffWorkInfoSchema, nextOfKinSchema, medicalSchema} from 'src/@core/Formschema'
...
import { defaultNextOfKinValues, defaultUpdateStaffPersonalValues, defaultWorkInfoValues, defaultMedicalValues } from '../../../@core/FormSchema/formDefaultvalues'
...
const UpdateStaff = ({open, closeModal, refetchStaffs, selectedStaff}) => {
  ...
  const handleForward =  () => {
    ...
    const handleReset = () => {
        ...
        residentialAddress: '', maritalStatus: '', gender: '', city: '', state: '', lga: '', religion: '', staffDescription: '' })
        ...
        >
          ...
          <form key={0} onSubmit={handlePersonalSubmit(handleForward)} >
            <Grid container spacing={5}>
              ...
              <Grid item xs={12} sm={4}>
                <FormController name='religion' control={personalControl} requireBoolean={false} label="Religion" error={personalErrors['religion']} errorMessage={personalErrors.religion?.message} />
              </Grid>
