...
const EditActor = ({ open, closeModal, refetchData, endpointUrl, selectedActor }) => {
  ...
  useEffect(() => {
    ...
    setValue('dateOfBirth', new Date(selectedActor.dateOfBirth))

    // formatDateToMMDDDYYY(selectedActor.dateOfBirth)
