...
const ListTeachers = ({Users, ClassList}) => {
  return (

    <Grid container spacing={6}>
    <Grid item xs={12} md={12}>

        <Typography sx={{mt: 3, mb: 3, fontWeight: 700}}>Subject Teachers</Typography>
        ...
        <div>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
            <Box sx={{ mr: 3, display: 'flex', alignItems: 'center', '& svg': { mr: 1, color: 'success.main' } }}>
              ...
              <Typography variant='caption'>{`${user?.staffDescription}` || `No Staff Description`}</Typography>
            </Box>
