...
const GuardianStatistics = ({user}) => {

    const [numberOfWard, setWard] = useState(0)
    ...
    <Grid item xs={6} md={3}>
      <Box sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column' }}>
          <Typography variant='h5'>{numberOfWard?.length || 0}</Typography>
...
export default GuardianStatistics
